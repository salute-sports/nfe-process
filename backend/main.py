...
@app.post("/extract")
async def extract_xml(file: UploadFile = File(...)):
    ...
    try:
        ...
        if data_emissao_raw:
            try:
                # dhEmi pode vir como 2024-04-16T09:00:00-03:00
